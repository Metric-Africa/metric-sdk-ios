...
#ifndef METRICSDK_SWIFT_H
#define METRICSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MetricSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9MetricSDK32LaunchVerificationViewController")
@interface LaunchVerificationViewController : UIViewController <UITableViewDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC9MetricSDK10NFCManager")
...
@interface NFCManager (SWIFT_EXTENSION(MetricSDK)) <NFCNDEFReaderSessionDelegate>
...
SWIFT_CLASS("_TtC9MetricSDK14PassportReader") SWIFT_AVAILABILITY(ios,introduced=15)
...
SWIFT_CLASS("_TtC9MetricSDK20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(MetricSDK))
...
SWIFT_CLASS("_TtC9MetricSDK14PhoneNumberKit")
...
SWIFT_CLASS("_TtC9MetricSDK20PhoneNumberTextField")
...
SWIFT_CLASS("_TtC9MetricSDK23SelfieTipViewController")
@interface SelfieTipViewController : UIViewController <UITableViewDelegate>
- (void)viewDidLoad;
